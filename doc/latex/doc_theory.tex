...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{single_neuron}
...
\begin{figure}[h]
	\ContinuedFloat*
	\centering
	\includegraphics[width=0.8\textwidth]{receptive_field_1}
...
\begin{figure}[h]
	\ContinuedFloat
	\centering
	\includegraphics[width=0.8\textwidth]{receptive_field_2}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{feature_maps}
...
%Ein gewisser Prozentsatz der \textit{Neuronen} eines \textit{Dropout-Layers} wird für das Training temporär deaktiviert, d.h. sie werden bei der Berechnung des Gradienten weder berücksichtigt noch justiert. Wie auch bei den \textit{ReLU-Layern} kann dadurch die Parameterlandschaft reduziert werden, welches wiederum das \textit{KNN} resistenter gegenüber Überanpassung macht und zudem das Training beschleunigt.
