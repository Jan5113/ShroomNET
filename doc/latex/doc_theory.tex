...
\vspace*{2mm}
\end{equation}
wobei $x_1,...,x_n$ den Eingangswerten und $a$ dem Ausgangswert $a$ entspricht. Die Variablen $w_1,...,w_n$ und $b$ sind \textit{Parameter} und werden nicht von den Eingangsdaten beeinflusst.
